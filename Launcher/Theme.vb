...
' Hi!
' I'm Dabsunter, the developper of CraftCreeper's MC launcher and
' I respect Mephobia, the creator of this beautiful VB theme.
' So I give a special thanks to Mephobia.

'           PS: I'm french and my english is a little bad... XD
...
Public Class PerplexGroupBox : Inherits ContainerControl
    ...
    Protected Overrides Sub OnPaint(e As System.Windows.Forms.PaintEventArgs)
        ...
        G.DrawString(Text, drawFont, New SolidBrush(Color.WhiteSmoke), 67, 14, New StringFormat() With {.Alignment = StringAlignment.Far, .LineAlignment = StringAlignment.Center})
